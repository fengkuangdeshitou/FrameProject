...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.badgeL.textColor = [[JMConfig shareConfig] badgeTextColor];
        ...
        self.badgeL.backgroundColor = [[JMConfig shareConfig] badgeBackgroundColor];
...
- (void)setType:(JMBadgeValueType)type {
    ...
    JMConfigBadgeAnimType animType = [[JMConfig shareConfig] animType];
