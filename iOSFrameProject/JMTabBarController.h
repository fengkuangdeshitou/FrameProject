...
@protocol JMTabBarControllerDelegate <NSObject>
@optional
- (BOOL)willShowSelectViewDidSelectIndex:(NSInteger)selectIndex;
@end
...
@property (nonatomic, weak) id<JMTabBarControllerDelegate> mmDelegate;
