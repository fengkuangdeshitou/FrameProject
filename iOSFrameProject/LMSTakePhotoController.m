...
- (IBAction)done:(UIButton *)sender {
    ...
    if ([_delegate respondsToSelector:@selector(didFinishPickingImage:takeImage:)]) {
        [_delegate didFinishPickingImage:self takeImage:previewImage];
    }
}
