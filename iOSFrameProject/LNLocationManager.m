...
- (void)startWithBlock:(void (^)(void))start completionAllBlock:(void (^)( NSArray<CLLocation *>*))success failure:(void (^)(CLLocation *, NSError *))failure{
    self.startBlock = start;
    self.successCompletionAllBlock = success;
...
- (void)startLocation{
    ...
    self.loactionManager.distanceFilter = kCLLocationAccuracyKilometer;
...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray<CLLocation *> *)locations{
    ...
    if (self.successCompletionAllBlock) {
        self.successCompletionAllBlock(locations);
    } else {
