...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.title.font = [UIFont systemFontOfSize:[[JMConfig shareConfig] titleFont]];
...
- (void)layoutSubviews {
    ...
    CGSize imageSize = [[JMConfig shareConfig] imageSize];
    CGFloat imageY = [[JMConfig shareConfig] imageOffset];
    if ([[JMConfig shareConfig] typeLayout] == JMConfigTypeLayoutImage) {
    ...
    CGFloat titleY = self.height - titleH - [[JMConfig shareConfig] titleOffset];
