...
public class LPBannerView: UIView, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    fileprivate var pageControl: PillPageControl?
...
extension LPBannerView {
    ...
    fileprivate func setupPageControl() {
        ...
        pageControl = PillPageControl(frame: CGRect.zero)
        pageControl?.pageCount = imagePaths.count
//        pageControl?.currentPage = pageIndex
        pageControl?.progress = CGFloat(CGFloat(pageIndex)/CGFloat(self.imagePaths.count))
...
//        pageControl?.currentPage = pageIndex
        ...
        // 增加蒙版
//        let maskImageView = UIImageView.init(frame: self.bounds)
//        maskImageView.image = #imageLiteral(resourceName: "home_advertie_mask")
...
extension LPBannerView {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageView.backgroundColor = UIColor.init(red: CGFloat(arc4random() % 131 + 100)/255.0, green: CGFloat(arc4random() % 131 + 100)/255.0, blue: CGFloat(arc4random() % 131 + 100)/255.0, alpha: 1.0)
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        pageControl?.progress = CGFloat(indexOnPageControl)
    }
