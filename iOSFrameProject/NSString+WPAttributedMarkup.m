...
//    paraStyle.alignment = NSTextAlignmentLeft;
    paraStyle.lineSpacing = spaceLine; //设置行间距
...
//    paraStyle.tailIndent = 0;
    ...
    // Setup base attributes
    [as setAttributes:@{NSUnderlineStyleAttributeName:[NSNumber numberWithInteger:NSUnderlineStyleNone], NSParagraphStyleAttributeName:paraStyle, NSKernAttributeName:@0.0f} range:NSMakeRange(0,[as length])];
...
-(NSAttributedString*)attributedStringWithStyleBook:(NSDictionary*)fontbook andSpaceLine:(float)spaceLine andTextIndex:(NSRange)textRange
{
    ...
    // special text add line
    [as setAttributes:@{NSUnderlineStyleAttributeName:[NSNumber numberWithInteger:NSUnderlineStyleSingle], NSParagraphStyleAttributeName:paraStyle, NSKernAttributeName:@0.0f} range:textRange];
