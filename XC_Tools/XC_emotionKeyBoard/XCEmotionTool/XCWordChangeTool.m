 ...
 *  @return 属性文字
 */
+(NSAttributedString *)attributedTextWithText:(NSString *)text andLineSpacing:(CGFloat)lineSpacing
{
    ...
    for (XCtextExchangeAttachModel *part in parts) {
        ...
        if (part.isEmotion) { // 表情
            ...
            paraStyle.lineSpacing = 6.0; //设置行间距
            ...
            substr = [[NSAttributedString alloc] initWithString:part.text attributes:@{
                                                                                       NSForegroundColorAttributeName :  [UIColor colorWithRed:69.0/255.0 green:172.0/255.0 blue:237.0/255.0 alpha:1.0]                                                                                      }];
